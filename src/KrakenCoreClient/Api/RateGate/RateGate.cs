...
namespace KrakenCoreClient.Api.RateGate
{
    /// <inheritdoc />
    /// <summary>
    ...
    /// <remarks>
    ///     <para>
    ///     To control the rate of an action using a <see cref="T:KrakenCoreClient.Api.RateGate.RateGate" />, 
    ///     code should simply call <see cref="M:KrakenCoreClient.Api.RateGate.RateGate.WaitToProceed" /> prior to 
    ///     performing the action. <see cref="M:KrakenCoreClient.Api.RateGate.RateGate.WaitToProceed" /> will block
    ///     the current thread until the action is allowed based on the rate 
    ///     limit.
    ///     </para>
    ///     <para>
    ///     This class is thread safe. A single <see cref="T:KrakenCoreClient.Api.RateGate.RateGate" /> instance 
